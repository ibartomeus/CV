...
teach <- read.csv("data/teaching_mentoring.csv")
...
Info                                                                 |                                                                                                              |
-------------------------------------------------------------------- |  ------------------------------------------------------------------------------------------------------------| 
E-mail: nacho.bartomeus@gmail.com                                    | Google Scholar: [http://tinyurl.com/bartomeus](http://tinyurl.com/bartomeus)                                 | 
Date of birth: 09-April-1981                                         | Altmetrics: [https://impactstory.org/IgnasiBartomeus](https://impactstory.org/IgnasiBartomeus)               |   
Nationality: Spanish                                                 | R code in Github: [https://github.com/ibartomeus](https://github.com/ibartomeus)                             | 
Webpage: [http://www.bartomeuslab.com](http://www.bartomeuslab.com)  | Twitter: [\@ibartomeus](https://twitter.com/ibartomeus)                                                      |   
...
ment <- subset(exp_ment, category == "mentoring", select = c("position", "date", "value"))
#can sort by date? need date in readable format :(
colnames(ment) <- NULL
rownames(ment) <- NULL
